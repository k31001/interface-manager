 ...
 * Theme-aware: body is neutral-900, the face/pins use surface + currentColor so
 * the mascot keeps its contrast on every theme (including dark).
 */
  ...
  return (
    <span className={cx("im-logo inline-grid place-items-center", className)}>
      <svg viewBox="0 0 40 40" width={40} height={40} fill="none" className="h-full w-full" aria-hidden>
        ...
        {/* inner die outline */}
        <rect x="11.5" y="11.5" width="17" height="17" rx="4.5" stroke="var(--surface)" strokeOpacity="0.18" strokeWidth="1.2" />
        {/* eyes */}
        <g className="im-eyes" fill="var(--surface)">
          <rect x="15" y="17" width="3.4" height="4.6" rx="1.7" />
          <rect x="21.6" y="17" width="3.4" height="4.6" rx="1.7" />
        </g>
        {/* smile */}
        <path d="M16.4 25c1.3 1.5 5.9 1.5 7.2 0" stroke="var(--surface)" strokeWidth="1.7" strokeLinecap="round" fill="none" />
      </svg>
    </span>
  );
}
