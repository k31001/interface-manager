...
export function PageHeader({
  ...
  return (
    <div className="sticky top-0 z-30 flex min-h-14 flex-wrap items-center gap-x-4 gap-y-2 border-b border-neutral-200 bg-[var(--header-bg)] px-6 py-2.5 backdrop-blur">
      <div>
